...
function IconFruit() {
  return (
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <path d="M28 16c-3-7-9-9-14-8 1 7 5 11 13 12" />
      <path d="M35 15c5-8 13-9 18-5-2 8-8 11-17 10" />
      <path d="M32 21c-10-8-23-3-24 11-1 13 11 25 24 25s25-12 24-25c-1-14-14-19-24-11Z" />
    </svg>
  );
}
...
function IconFactory() {
  return (
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <path d="M8 52h48" />
      <path d="M12 52V30l13 8V28l14 8V18h10v34" />
      <path d="M20 46h6M34 46h6M48 46h4" />
      <path d="M43 18V10h10v8" />
    </svg>
  );
}
...
function IconTruck() {
  return (
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <path d="M7 39V20h32v25H7z" />
      <path d="M39 29h10l8 10v6H39" />
      <circle cx="20" cy="48" r="5" />
      <circle cx="48" cy="48" r="5" />
      <path d="M12 48h3M25 48h18" />
    </svg>
  );
}
...
function IconShield() {
  return (
    <svg viewBox="0 0 64 64" aria-hidden="true">
      <path d="M32 6 52 14v15c0 14-8 24-20 29C20 53 12 43 12 29V14l20-8Z" />
      <path d="M23 32l6 6 13-16" />
    </svg>
  );
}
  ...
  return (
    <section id="start" className="hero">
      <div className="heroFrame">
        ...
        <p className="lead">
          Nowoczesna, prężnie rozwijająca się firma z województwa lubelskiego,
          specjalizująca się w skupie, przerobie owoców oraz transporcie krajowym
          i międzynarodowym.
        </p>
  ...
  return (
    <section className="services">
      <article>
        <IconFruit />
        <h3>Skup owoców</h3>
        <p>Sieć punktów skupu w województwie lubelskim oraz współpraca z producentami rolnymi.</p>
      </article>
      <article>
        <IconFactory />
        <h3>Przetwórstwo</h3>
        <p>Nowoczesna linia produkcyjna, chłodzenie chillerem, pulpa owocowa i mrożenie.</p>
      </article>
      <article>
        <IconTruck />
        <h3>Transport</h3>
        <p>Transport ciężki: firanki standard, chłodnie, cysterny oraz kierunki europejskie.</p>
      </article>
      <article>
        <IconShield />
        <h3>Jakość</h3>
        <p>Praca zgodna ze standardami HACCP oraz IFS FOOD.</p>
      </article>
    </section>
  );
}
  ...
  return (
    <section id="onas" className="section split">
      <div className="sectionTitle">
        ...
        <h2>Profesjonalny partner w branży owocowej.</h2>
      </div>
      <div className="textPanel">
        <p>
          AGRO-MAR Mariusz Bańka Sp. z o.o. to firma łącząca doświadczenie w skupie
          surowca z nowoczesnym zapleczem produkcyjnym oraz własną flotą transportową.
        </p>
        <p>
          Naszą działalność opieramy na jakości, terminowości i stabilnej współpracy
          z producentami rolnymi oraz kontrahentami. Dzięki sieci punktów skupu
          jesteśmy blisko dostawców i sprawnie obsługujemy sezon owocowy.
        </p>
      </div>
    </section>
  );
...
function FruitBuying() {
  return (
    <section id="skup" className="section darkSection">
      <div className="sectionHeader">
        <p className="overline">Skup owoców</p>
        <h2>Kupujemy owoce sezonowe i przemysłowe</h2>
        <p>
          Posiadamy 10 punktów skupu w województwie lubelskim. Skupujemy owoce miękkie,
          pestkowe oraz jabłko przemysłowe.
        </p>
      </div>

      <div className="elegantFruitList">
  ...
  return (
    <section id="producenci" className="section farmers">
      <div className="sectionTitle">
        ...
        <h2>Stała współpraca, sprawna organizacja sezonu.</h2>
      </div>
      <div className="textPanel">
        <p>
          Producentom rolnym oferujemy przejrzysty kontakt, sieć punktów skupu oraz
          sprawną obsługę dostaw w intensywnym okresie sezonu.
        </p>
        <ul>
          <li>10 punktów skupu w województwie lubelskim</li>
          <li>skup owoców miękkich, pestkowych i przemysłowych</li>
...
function Processing() {
  return (
    <section className="section processing">
      <div className="sectionHeader">
        <p className="overline dark">Przetwórstwo</p>
  ...
  return (
    <section className="certificates">
      <div>
        ...
        <p>
          Pracujemy zgodnie ze standardami jakości i bezpieczeństwa żywności,
          potwierdzonymi certyfikacją HACCP oraz IFS FOOD.
        </p>
      </div>
    </section>
  );
  ...
  return (
    <section id="galeria" className="section gallery">
      <div className="sectionHeader">
        ...
        <h2>Miejsce na zdjęcia firmy, owoców, produkcji i floty</h2>
      </div>
      <div className="galleryGrid">
        {["Zakład produkcyjny", "Punkty skupu", "Owoce", "Linia produkcyjna", "Flota", "Transport chłodniczy"].map((item) => (
